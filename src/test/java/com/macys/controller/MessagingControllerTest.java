...
public class MessagingControllerTest {
	...
	@Test
	public void sendJsonMessageToGcpTest() throws Exception {
		OrderMessageJson mockMsg = new OrderMessageJson();
		...
		when(messagingService.sendJsonMessageWithGCP(mockMsg)).thenReturn(new ResponseEntity<>(true, HttpStatus.OK));
	...
	@Test
	public void sendXmlMessageToGcpTest() throws Exception {
		FulfillmentOrder fullfillOrder = mock(FulfillmentOrder.class);
		...
		when(messagingService.sendXmlMessageWithGCP(fullfillOrder)).thenReturn(new ResponseEntity<>(true, HttpStatus.OK));

		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/macys/producer/gcp/xml")
				.accept(MediaType.APPLICATION_XML).content(inputXml).contentType(MediaType.APPLICATION_XML);
